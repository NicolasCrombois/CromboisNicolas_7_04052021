  ...
  methods: {
    register(){
      ...
      if(this.errors.length == 0){
        ...
        axios.post(process.env.VUE_APP_API_HOST+'auth/signup', { email: this.user.email, password: this.user.password, firstname: this.user.firstname, name: this.user.name })
        .then ((res) => {
